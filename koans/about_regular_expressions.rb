...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  # Why?
  # 
  # A repetition operator will grab all the matching characters that satisfy
  # the match condition, and not simply the first one. 
  #
  # e.g. "abbbbb"[/ab*/] will return "abbbbb"
  #
  # It's greedy because it finds as many characters as it can. 
  ...
  def test_distinguish_character_classes_from_alternations
    jeff = /[Jeff]*/
    assert_equal "Jef", "Jef"[jeff]
    assert_equal "efJ", "efJ"[jeff]
  end
  ...
  #
  # Character classes don't specify order, and they don't allow you to specify
  # duplicate characters. 
  #
  # If you wanted to match "Jeff", you could specify the character class [Jeff]+, but
  # that would match "Jeff" as well as "Jef" as well as "eJf"
  ...
  def test_sub_is_like_find_and_replace
    ...
    #This says take the first match, and substring the first character, and replace
    #that match with the resulting substring
  end
